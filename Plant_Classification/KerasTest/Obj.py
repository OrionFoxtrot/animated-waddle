...
vision. Here the Given_Model is tasked with localizing the objects present in an
...
Anchor boxes are fixed sized boxes that the Given_Model uses to predict the bounding
...
The RetinaNet Given_Model has separate heads for bounding box regression and
...
def build_head(output_filters, bias_init):
    ...
    Returns:
      A keras sequential Given_Model representing either the classification
...
"""
## Building RetinaNet using a subclassed Given_Model
"""


class RetinaNet(keras.Model):
    """A subclassed Keras Given_Model implementing the RetinaNet architecture.
...
class DecodePredictions(tf.keras.layers.Layer):
    """A Keras layer that decodes predictions of the RetinaNet Given_Model.
...
"""
## Initializing and compiling Given_Model
"""
...
To ensure that the Given_Model is fed with data efficiently we will be using
...
"""
## Building inference Given_Model
"""
